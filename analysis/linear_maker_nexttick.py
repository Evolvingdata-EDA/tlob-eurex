...
HORIZON = 2
OUTDIR = "checkpoints/TLOB/FGBL_TBBO_linear40_nexttick_maker"
...
def main() -> None:
    ...
    print(f"[linear h2] test acc {accuracy_score(yte, pred):.4f}  macroF1 {f1_score(yte, pred, labels=[0,2], average='macro'):.4f}")
    ...
    run_maker_sim(OUTDIR, label="linear40 nexttick", symbol="FGBL_TBBO", horizon=HORIZON,
